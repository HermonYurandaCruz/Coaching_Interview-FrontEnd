 ...
 * limitations under the License.
 */
var g = "9.21.0", w = new l("@firebase/firestore");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var F = "cancelled", P = "unknown", V = "invalid-argument", D = "deadline-exceeded", O = "not-found", N = "permission-denied", q = "unauthenticated", R = "resource-exhausted", C = "failed-precondition", x = "aborted", j = "out-of-range", L = "unimplemented", M = "internal", U = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
...
function vt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? "ok" : t >= 400 && t < 500 ? C : t >= 500 && t < 600 ? M : P;
    }
}
    ...
    return t.fromBase64String = function(e) {
        var n = function(t) {
            try {
                ...
                throw "undefined" != typeof DOMException && t instanceof DOMException ? new It("Invalid base64 string: " + t) : t;
            }
        }(e);
        return new t(n);
 ...
 */ function Rt(t) {
    var e = Pt(t.mapValue.fields.__local_write_time__.timestampValue);
...
/** Extracts the backend's type order for the provided value. */ function xt(t) {
    return "nullValue" in t ? 0 /* TypeOrder.NullValue */ : "booleanValue" in t ? 1 /* TypeOrder.BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* TypeOrder.NumberValue */ : "timestampValue" in t ? 3 /* TypeOrder.TimestampValue */ : "stringValue" in t ? 5 /* TypeOrder.StringValue */ : "bytesValue" in t ? 6 /* TypeOrder.BlobValue */ : "referenceValue" in t ? 7 /* TypeOrder.RefValue */ : "geoPointValue" in t ? 8 /* TypeOrder.GeoPointValue */ : "arrayValue" in t ? 9 /* TypeOrder.ArrayValue */ : "mapValue" in t ? Nt(t) ? 4 /* TypeOrder.ServerTimestampValue */ : 
    ...
    switch (n) {
      ...
      case 3 /* TypeOrder.TimestampValue */ :
        return function(t, e) {
            ...
            var n = Pt(t.timestampValue), r = Pt(e.timestampValue);
      ...
      case 9 /* TypeOrder.ArrayValue */ :
        return Et(t.arrayValue.values || [], e.arrayValue.values || [], jt);
    ...
    switch (n) {
      ...
      case 7 /* TypeOrder.RefValue */ :
        return function(t, e) {
            ...
            return Tt(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* TypeOrder.GeoPointValue */ :
        return function(t, e) {
            var n = Tt(Vt(t.latitude), Vt(e.latitude));
            return 0 !== n ? n : Tt(Vt(t.longitude), Vt(e.longitude));
      ...
      case 10 /* TypeOrder.ObjectValue */ :
        return function(t, e) {
            ...
            for (var a = 0; a < r.length && a < o.length; ++a) {
                var u = Tt(r[a], o[a]);
                if (0 !== u) return u;
                var s = Mt(n[r[a]], i[o[a]]);
                if (0 !== s) return s;
            }
            return Tt(r.length, o.length);
...
function Ut(t, e) {
    ...
    var n = Pt(t), r = Pt(e), i = Tt(n.seconds, r.seconds);
    return 0 !== i ? i : Tt(n.nanos, r.nanos);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Jt = function() {}, Xt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* Operator.IN */ === e || "not-in" /* Operator.NOT_IN */ === e ? this.createKeyFieldInFilter(t, e, r) : new te(t, e, r) : "array-contains" /* Operator.ARRAY_CONTAINS */ === e ? new ie(t, r) : "in" /* Operator.IN */ === e ? new oe(t, r) : "not-in" /* Operator.NOT_IN */ === e ? new ae(t, r) : "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === e ? new ue(t, r) : new n(t, e, r);
    }, n.createKeyFieldInFilter = function(t, e, n) {
        return "in" /* Operator.IN */ === e ? new ee(t, n) : new ne(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* Operator.NOT_EQUAL */ === this.op ? null !== e && this.matchesComparison(Mt(e, this.value)) : null !== e && xt(this.value) === xt(e) && this.matchesComparison(Mt(e, this.value));
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).filters = t, r.op = n, r.N = null, r;
    }
    /**
     * Creates a filter based on the provided arguments.
     */    return t(n, e), n.create = function(t, e) {
        ...
        return null !== this.N || (this.N = this.filters.reduce((function(t, e) {
...
function Zt(t, e) {
    return t instanceof Xt ? function(t, e) {
        return e instanceof Xt && t.op === e.op && t.field.isEqual(e.field) && jt(t.value, e.value);
...
}(Xt), ee = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* Operator.IN */ , n) || this).keys = re("in" /* Operator.IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Xt), ne = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* Operator.NOT_IN */ , n) || this).keys = re("not-in" /* Operator.NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** A Filter that implements the array-contains operator. */ var ie = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return zt(e) && Lt(e.arrayValue, this.value);
    }, n;
...
}(Xt), se = function(t, e /* Direction.ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function ce(t, e) {
 ...
 */ var le = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, pe.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, pe.BLACK, null, null));
    }, 
...
var de = /** @class */ function() {
    ...
    t.prototype.unionWith = function(e) {
        for (var n = new de(rt.comparator), r = 0, i = this.fields; r < i.length; r++) {
            var o = i[r];
            n = n.add(o);
        }
    ...
    t.prototype.covers = function(t) {
        ...
        return Et(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), ve = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        ...
        /* version */ le.min(), 
        /* readTime */ le.min(), 
        /* createTime */ le.min(), ve.empty(), 0 /* DocumentState.SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        ...
        /* version */ n, 
        /* readTime */ le.min(), 
        /* createTime */ le.min(), ve.empty(), 2 /* DocumentState.HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
 ...
 */ function ke(t) {
    ...
    if (null === e.q) {
        ...
        n.isKeyField() || e.q.push(new se(n)), e.q.push(new se(rt.keyField(), "asc" /* Direction.ASCENDING */)); else {
 ...
 */ function Ie(t) {
    var e = A(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = _e(e.path, e.collectionGroup, ke(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.O = _e(e.path, e.collectionGroup, n, e.filters, e.limit, u, s);
    }
    return e.O;
}

function Ae(t, e) {
    e.getFirstInequalityField(), Ee(t);
...
}(), Ce = function() {}, xe = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function Ye(t) {
    return I(!!t), le.fromTimestamp(function(t) {
        var e = Pt(t);
        return new Ot(e.seconds, e.nanos);
    }(t));
}
 ...
 */ var fn = /** @class */ function() {
    ...
    return t(n, e), n.prototype.X = function() {
        if (this.J) throw new B(C, "The client has already been terminated.");
    }, 
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.R = function(t, e, n, r) {
        ...
        return this.X(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(o) {
            var a = o[0], u = o[1];
            return i.connection.R(t, e, n, a, u, r);
        })).catch((function(t) {
...
function pn(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = A(t), i = Ze(e.serializer) + "/documents", o = {
                ...
                return a = n.sent(), u = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = Xe(t, e.found.name), r = Ye(e.found.updateTime), i = e.found.createTime ? Ye(e.found.createTime) : le.min(), o = new ve({
                                mapValue: {
                                    fields: e.found.fields
                                }
                            });
                            return ge.newFoundDocument(n, r, i, o);
 ...
 */ function mn(t) {
    ...
    if (!yn.has(t)) {
        ...
        new $(i, o, a, u.host, u.ssl, u.experimentalForceLongPolling, u.experimentalAutoDetectLongPolling, u.useFetchStreams))), n = ln(t._databaseId), r = function(t, e, n, r) {
 ...
 */ var vn = /** @class */ function() {
    function t(t) {
        ...
        this.experimentalForceLongPolling || void 0 === t.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = !1 : 
    ...
    t.prototype._terminate = function() {
        return t = this, (e = yn.get(t)) && (b("ComponentProvider", "Removing Datastore"), 
 ...
 */ function bn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        t._authCredentials = new G(new Q(a, u));
    }
}
...
t, e) {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, new be(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function Fn(t, e) {
    ...
    if (!(t instanceof kn || t instanceof An)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Pn(t, e) {
    if (t = ct(t, gn), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(V, "Invalid collection ID '".concat(e, "' passed to function collectionGroup(). Collection IDs must not contain '/'."));
    return new In(t, 
    /* converter= */ null, function(t) {
        return new be(et.emptyPath(), t);
    }(e));
}
...
function Vn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = bt.D()), ot("doc", "path", e), t instanceof gn) {
        var o = et.fromString.apply(et, r([ e ], n, !1));
    ...
    if (!(t instanceof kn || t instanceof An)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child(et.fromString.apply(et, r([ e ], n, !1)));
    return at(a), new kn(t.firestore, t instanceof An ? t.converter : null, new it(a));
}
 ...
 * Firestore database.
 */ function Dn(t, e) {
    return t = p(t), e = p(e), (t instanceof kn || t instanceof An) && (e instanceof kn || e instanceof An) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function On(t, e) {
    return t = p(t), e = p(e), t instanceof In && e instanceof In && t.firestore === e.firestore && function(t, e) {
        return function(t, e) {
            ...
            for (var r = 0; r < t.filters.length; r++) if (!Zt(t.filters[r], e.filters[r])) return !1;
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new je(t, this.data, this.fieldMask, e, this.fieldTransforms) : new xe(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Mn = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Bn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.nt = function(e) {
        ...
        return sr(t, this.settings.methodName, this.settings.at || !1, this.path, this.settings.ht);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Un(this.et) && jn.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }, t;
}(), zn = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Kn(t, e, n, r, i, o) {
    ...
    var u, s, c = nr(r, a);
    if (o.merge) u = new me(a.fieldMask), s = a.fieldTransforms; else if (o.mergeFields) {
        ...
        u = new me(l), s = a.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, s = a.fieldTransforms;
    return new Ln(new ve(c), u, s);
}
...
var Yn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ne(t.serializer, Fe(t.serializer, this.dt));
...
/** Parse update data from a list of field/value arguments. */ function Zn(t, e, n, r, i, o) {
    ...
    for (var l = [], f = ve.empty(), h = u.length - 1; h >= 0; --h) if (!cr(l, u[h])) {
        var d = u[h], y = s[h];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = p(y);
 ...
 */ function er(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Un(e.et)) throw e.ct("".concat(t._methodName, "() can only be used with update() and set()"));
    ...
    return function(t, e) {
        ...
        if (t instanceof Nn) return {
            bytesValue: Ge(e.serializer, t._byteString)
        };
        if (t instanceof kn) {
...
function rr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Ot || t instanceof xn || t instanceof Nn || t instanceof kn || t instanceof Cn);
}
 ...
 */ function or(t, e, n) {
    ...
    // FieldPath.
    (e = p(e)) instanceof qn) return e._internalPath;
 ...
 */
function pr(t, e) {
    return t = p(t), e = p(e), t instanceof lr && e instanceof lr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof hr && e instanceof hr && On(t.query, e.query) && Et(t.docs, e.docs, pr)
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
}
...
function dr(t, e) {
    return "string" == typeof e ? ur(t, e) : e instanceof qn ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var gr = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e, r) {
        ...
        var e = this._parse(t);
        return xr(t._query, e), new In(t.firestore, t.converter, Ae(t._query, e));
 ...
 */ var _r = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e) {
        ...
        }(t._query, e), new In(t.firestore, t.converter, Ae(t._query, e)));
...
var Fr = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e, r) {
        ...
        var e = qr(t, this.type, this._docOrFields, this._inclusive);
        return new In(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function qr(t, e, n, r) {
    if (n[0] = p(n[0]), n[0] instanceof lr) return function(t, e, n, r, i) {
        ...
        for (var o = [], a = 0, u = ke(t); a < u.length; a++) {
            var s = u[a];
            if (s.field.isKeyField()) o.push(Bt(e, r.key)); else {
                var c = r.data.field(s.field);
                if (Nt(c)) throw new B(V, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], s = 0; s < i.length; s++) {
            ...
            if (a[s].field.isKeyField()) {
                ...
                if (!Se(t) && -1 !== c.indexOf("/")) throw new B(V, "Invalid query. When querying a collection and ordering by documentId(), the value passed to ".concat(r, "() must be a plain document ID, but '").concat(c, "' contains a slash."));
...
function Rr(t, e, n) {
    if ("string" == typeof (n = p(n))) {
        ...
        if (!Se(e) && -1 !== n.indexOf("/")) throw new B(V, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '".concat(n, "' contains a '/' character."));
        ...
        return Bt(t, new it(r));
    }
    if (n instanceof kn) return Bt(t, n._key);
